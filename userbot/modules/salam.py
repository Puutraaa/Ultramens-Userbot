...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**Ehh Engga Deh,Kek Kan Cantik Kaya Artis Korea☺️**")
    sleep(1)
    await typew.edit("**Tapi Boong🤣**")
    sleep(1)
    await typew.edit("**HAHAHAHAHAHAHA**")
    sleep(1)
    await typew.edit("**Udah Ahh Takut Kek Nangis Minta Permen🍬**")
    sleep(1)
...
async def typewriter(typew):
    ...
    await typew.edit("**HAHAHAHAHAHAHA**")
    sleep(1)
    await typew.edit("**Udah Ahh Takut Kek Nangis Minta Pap Memek**")
    sleep(1)
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**Kan Askar Mukanya Kaya Jerfi Nichol**")
    sleep(1)
    await typew.edit("**Ehh Engga Deh,Kek Kan Ganteng Kaya Artis Korea☺️**")
    sleep(1)
    await typew.edit("**Tapi boong 🤣**")
    ...
    await typew.edit("**HAHAHAHAHAHAHA**")
    sleep(1)
    await typew.edit("**Udah Ahh Takut Kek Nangis Minta Vps**")
    sleep(1)
